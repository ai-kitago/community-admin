<div class="modal fade bd-studio-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
              ...
              <ul class="list-unstyled table-ul list">
                ...
                <li class="table-li">
                  ...
                  <div class="table-cell">
                    ...
                    <p class="table-description"><small class="shop-name" data-shop-name="<?php echo $val['shopname']; ?>"><?php echo $val['shopname']; ?>&nbsp;/&nbsp;<span class="table-pref" data-pref-name="<?php echo $area; ?>"><?php echo $area; ?></span></small><br><span data-sub-name="<?php echo $val['subname']; ?>"><?php echo $val['subname']; ?></span></p>
                  </div>
                  <div class="table-cell table-button">
                    <div class="form-group">
                      <button class="btn btn-default btn-sm no-submit add data-id-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">申請</button>
                    </div>
                  </div>
                </li>
                <?php
